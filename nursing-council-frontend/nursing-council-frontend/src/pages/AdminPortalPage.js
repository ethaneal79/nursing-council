      ...
      {tab === 'dashboard' && stats && (
        <div>
          ...
          <div style={{ display: 'flex', gap: 14, flexWrap: 'wrap', marginBottom: 28 }}>
            <StatCard label="Total Applications" value={stats.totalApplications} color={COLORS.primary} />
            <StatCard label="Unprocessed" value={stats.unprocessed} color={COLORS.warning} />
            <StatCard label="Pending Approval" value={stats.pendingApproval} color={COLORS.accent} />
          ...
          <div style={{ display: 'flex', gap: 14, flexWrap: 'wrap' }}>
            <StatCard label="New Registrations" value={stats.newRegistrations} color="#5c7cfa" />
            <StatCard label="Renewals" value={stats.renewals} color="#7950f2" />
            <StatCard label="GNM Applications" value={stats.gnmCount} color="#0ca678" />
            <StatCard label="ANM Applications" value={stats.anmCount} color="#f76707" />
          </div>
        </div>
      )}
